...
import { setCommandNumber, setError, setMessage, setPaymentCompleted } from "../redux";
...
export default function CategoryPage() {
	...
	const sendOrderToAPI = async () => {
		...
		try {
			await axios.post(import.meta.env.VITE_API_URL + '/api/neworder', order)
			.then((res) => {dispatch(setCommandNumber(res.data.command_number))})
		} catch (err: any) {
