...
export default function test() {
    ...
    const command_number = useSelector((state: any) => state.payment.command_number);
              ...
              <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                >
                  ...
                  <div className="flex flex-col items-center h-[900px] justify-center overflow-y-scroll scroll-gray">
                     ...
                     <span className="text-[10rem] font-bold text-primary/70">{command_number < 10 ? "0" : ""}{command_number < 100 ? "0" : ""}{command_number}</span>
                  </div>
