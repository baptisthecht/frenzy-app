	...
	return (
		<Transition.Root
			show={
				...
				CompanyData.company.multiple_eat_here
			}
			as={Fragment}>
			<Dialog
				as="div"
				...
				<div className="fixed inset-0 z-10 overflow-y-auto">
                    ...
                    <button onClick={() => {handleClick(option)}} key={option}><span className='text-xl flex flex-col gap-5 items-center'>{option}</span></button>
								...
								<div className="flex flex-col h-[1000px] max-h-[1000px] overflow-y-scroll scroll-gray items-center justify-center gap-10">
									<button
										onClick={() => {
											handleClick("En salle");
										}}>
										<span className="text-xl flex flex-col items-center justify-center h-80 w-[600px] rounded-xl bg-gray-100">
											<img
												className="w-36"
												src="/inside.svg"></img>
									...
									<button
										onClick={() => {
											handleClick("En terrasse");
										}}>
										<span className="text-xl flex flex-col justify-center items-center h-80 w-[600px] rounded-xl bg-gray-100">
											<img
												className="w-36"
												src="/outside.svg"></img>
											<span className="text-2xl">
