          ...
          >
            <Dialog.Panel className="relative transform overflow-hidden rounded-3xl bg-white p-10 text-left shadow-xl transition-all h-[1400px] w-[800px] border-8 border-primary">
              ...
              <div className="flex flex-col h-[1000px] max-h-[1000px] overflow-y-scroll scroll-gray items-center justify-center gap-10">
                 <button onClick={() => {handleClick('En salle')}} ><span className='text-xl flex flex-col items-center justify-center h-80 w-[600px] rounded-xl bg-gray-100'><img className="w-36" src='/inside.svg'></img><span className='text-2xl'>En salle</span></span></button>
                 <button onClick={() => {handleClick('En terrasse')}} ><span className='text-xl flex flex-col justify-center items-center h-80 w-[600px] rounded-xl bg-gray-100'><img className="w-36" src='/outside.svg'></img><span className='text-2xl'>En terrasse</span></span></button>
              </div>
